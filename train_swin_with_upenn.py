...
train_transform = transforms.Compose(
    [
        ...
        # ConvertToMultiChannelBasedOnBratsClassesdI(keys="label"), # use in pipeline1
...
model = SwinUNETR(
    ...
    use_checkpoint=True,  # default True 
    use_v2=use_v2,
)
...
model_path = "trained_models/vtzpbajf_best_model:v0/model.pt"
